    ...
    <div>
        ...
        <div className="bg-base-300 rounded-xl shadow-xl overflow-hidden">
          <div className="relative  z-10 p-8 md:p-12 lg:p-16">
            <h1
              ...
              className=" flex text-3xl md:text-4xl lg:text-5xl font-bold mb-4"
            >
              <img
            ...
            <h1
              style={{ fontFamily: 'Bebas Neue' }}
              className=" mt-[-20px] text-3xl md:text-4xl lg:text-5xl font-bold mb-4"
            >
            ...
            <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl">
              ...
              the best facilities to elevate your game.
            </p>
            ...
            <div className="bg-base-100 dark:bg-base-300 p-4 rounded-box shadow-md max-w-3xl">
              ...
              {showFilters && (
                <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* Date Filter */}
                  <div>
                    <label className="label text-sm font-medium text-base-content">Date</label>
                    <input
                      type="date"
                      id="date"
                      name="date"
                  ...
                  <div className="md:col-span-3 flex justify-end gap-2">
                    <button className="btn btn-outline btn-secondary" onClick={clearFilters}>
                      Clear Filters
                    </button>
                    <button
      ...
      <section>
        <div className="flex justify-between items-center mb-6">
          <h2 style={{ fontFamily: 'Bebas Neue' }} className="text-2xl font-bold ">
            Available Cricket Boxes
          </h2>
          <div className="text-sm text-base-content/70">Showing {filteredBoxes.length} results</div>
        </div>
        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card bg-base-300 shadow-md p-6 text-center hover:scale-105 transition-transform">
            ...
            <p className="text-base-content/70">
              Find and book cricket boxes with just a few clicks. Filter by location, price, and
              availability.
            </p>
          </div>
          ...
          <div className="card bg-base-300 shadow-md p-6 text-center hover:scale-105 transition-transform">
            ...
            <h3 className="text-xl font-semibold mb-2 text-primary ">Real-time Availability</h3>
            <p className="text-base-content/70">
          ...
          <div className="card bg-base-300 shadow-md p-6 text-center hover:scale-105 transition-transform">
            ...
            <h3 className="text-xl font-semibold mb-2 text-primary ">Quality Locations</h3>
            <p className="text-base-content/70">
    ...
    <div className="card bg-base-300  shadow-md hover:shadow-lg transition-transform hover:-translate-y-1">
      <figure className="relative h-48 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-4 py-2">
          <div className="badge bg-red-500  text-white font-bold text-sm">₹{box.hourlyRate}/hr</div>
        </div>
      </figure>

      <div className="card-body p-4">
        <h3 style={{ fontFamily: 'Bebas Neue' }} className="card-title text-primary  text-lg">
          {box.name}
        </h3>
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="text-xs not-first-of-type:">(1 reviews)</span>
        </div>
