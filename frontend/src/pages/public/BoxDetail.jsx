...
import { MapPin, Clock, Calendar, ChevronRight, ChevronLeft, Star, Info } from 'lucide-react';
...
const BoxDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchBoxDetails = async () => {
      try {
        const response = await fetch(`http://localhost:5001/api/public/boxes/${id}`);
    ...
    // Mock data for demo
    setAvailableTimes(['09:00', '10:00', '11:00', '12:00', '14:00', '15:00', '16:00', '17:00', '18:00']);
  }, [id]);
  ...
  const checkAvailability = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5001/api/api/booking/check-slot', {
        method: 'POST',
        headers: {
      ...
      toast.success('Available times updated');
    } catch (error) {
  ...
  const mockBox = {
    ...
    description: 'High-quality cricket practice box with advanced bowling machine and analytics. Perfect for players of all skill levels, from beginners to professionals. Features include adjustable bowling speed and pitch, video analysis, and comfortable waiting area.',
    ...
    reviews: [
      {
        ...
        user: 'John Smith',
        rating: 5,
        comment: 'Excellent facilities! The bowling machine is top-notch and the video analysis helped me improve my technique.',
        date: '2023-03-15'
      },
      {
        id: 2,
  ...
  {displayBox && displayBox.images && displayBox.images.length > 0 ? (
    ...
    <p>No images available</p>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700 dark:text-gray-300">
              <div className="flex items-center">
                <Clock size={18} className="mr-2 text-yellow-600 dark:text-yellow-400" />
                <div>
              ...
              <div className="flex items-center">
                <Calendar size={18} className="mr-2 text-yellow-600 dark:text-yellow-400" />
                <div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
            ...
            <div className="bg-gray-200 dark:bg-gray-700 h-64 rounded-lg mb-3 flex items-center justify-center">
              <p className="text-gray-500 dark:text-gray-400 text-center p-4">
                <MapPin size={24} className="inline-block mb-2" /><br />
        ...
        <Card>
          ...
          {displayBox.reviews.map(review => (
            <div key={review.id} className="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700 last:border-0 last:mb-0 last:pb-0">
        ...
        <div className="sticky top-6">
          <Card className="mb-6">
            <div className="flex justify-between items-center mb-4">
              <div className="text-2xl font-bold text-yellow-800 dark:text-yellow-300">
                ...
                <span className="text-sm font-normal text-gray-600 dark:text-gray-400">/hour</span>
              </div>
              <div className="flex items-center">
                <Star className="w-5 h-5 text-yellow-500 fill-current" />
                <span className="text-gray-700 dark:text-gray-300 font-medium ml-1">
            ...
            {selectedTime && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-md mb-6">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                  ...
                  <div className="flex justify-between">
                    <span>Duration:</span>
                    <span className="font-medium text-gray-800 dark:text-gray-200">{duration} hour{duration > 1 ? 's' : ''}</span>
                  </div>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg shadow-sm">
            <div className="flex items-start">
              <Info size={20} className="mr-2 mt-0.5 text-yellow-600 dark:text-yellow-400 flex-shrink-0" />
